...
CREATE TABLE `questionaire_question_r` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='定义问卷中有哪些题目';
...
INSERT INTO `questionaire_question_r` VALUES (1,2,28,2,1,NULL,NULL,NULL,NULL,'y'),(2,1,29,2,1,NULL,NULL,NULL,NULL,'y');
...
-- Dump completed on 2019-08-18 11:26:50
