...
CREATE TABLE `questionaire_question_r` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='定义问卷中有哪些题目';
...
INSERT INTO `questionaire_question_r` VALUES (1,2,28,2,1,NULL,NULL,NULL,NULL,'y'),(2,1,29,2,1,NULL,NULL,NULL,NULL,'y'),(3,2,36,4,1,NULL,NULL,NULL,NULL,'y'),(4,1,37,4,1,NULL,NULL,NULL,NULL,'y'),(5,2,36,5,1,NULL,NULL,NULL,NULL,'y'),(6,1,38,5,1,NULL,NULL,NULL,NULL,'y');
