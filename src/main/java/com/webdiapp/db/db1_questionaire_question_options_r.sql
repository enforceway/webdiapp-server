...
CREATE TABLE `questionaire_question_options_r` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='问卷中题目对应带选项';
...
INSERT INTO `questionaire_question_options_r` VALUES (13,3,'国有第一',NULL,NULL,NULL,'y'),(14,3,'全能无敌',NULL,NULL,NULL,'y'),(15,4,'成吉思浩',NULL,NULL,NULL,'y'),(16,4,'努尔哈赤',NULL,NULL,NULL,'y'),(17,5,'tianqi',NULL,NULL,NULL,'y'),(18,5,'whynot',NULL,NULL,NULL,'y'),(19,6,'chossethewayw',NULL,NULL,NULL,'y'),(20,6,'noahti',NULL,NULL,NULL,'y');
